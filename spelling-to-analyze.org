...
** TODO Don't print the wavy lines

** TODO Improve startup time

** Fix grammar [ ]
*** [ ] Right click tells which grammar mistake was made
*** [ ] Don't print the grammar mistakes
*** [ ] Everything should return to the state it was in before a save
