...
** TODO Make tab scroll through the list of completions [0/2]
   - [ ] Shift tab doesn't work
   - [ ] The currently selected item is not highlighted
** DONE Remove "align right"
** TODO If you hit bold, bold the selected word if nothing is selected
** TODO Highlighting a bold thing changes everything to bold, and removing bold removes highlighting
** TODO Changing the size of the font should change the entire text block
