...
** Force a space after a period
   In other words, don't allow things like "... said Joe.Then he"

** Delete multiple spaces 

** Make sure there are no spaces before periods and after commas

** Don't print the wavy lines

* Things to see if I can fix automatically 

** Suggestions for apostrophes

** Is vs. are

** Plurals

** Capitalization in the middle of sentences
