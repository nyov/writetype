...
class Ui_settingsDialog(object):
    def setupUi(self, settingsDialog):
        ...
        self.thresholdSpinbox.setProperty("value",QtCore.QVariant(2))
        ...
        self.speedSlider.setProperty("value",QtCore.QVariant(0))
        ...
        self.spinBox.setProperty("value",QtCore.QVariant(0))
    ...
    def retranslateUi(self, settingsDialog):
        ...
        self.autocorrectionsTable.clear()
        self.autocorrectionsTable.setColumnCount(2)
        self.autocorrectionsTable.setRowCount(1)
